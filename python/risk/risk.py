...
def attack(no_of_dice):
    ...
    pygame.display.update()
    pygame.time.delay(DELAY) # need to change this to a click rather than a timer
...
# change the timer to a clicking system for when to stop showing the dice
# make a auto battle option